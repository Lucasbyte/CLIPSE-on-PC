...
function coletarDados(plu) {
    ...
    let vendaSelect = parseInt(document.querySelector(`select[name="venda-${plu}"]`).value.trim());
    let venda = vendaSelect
    let validade = parseInt(document.querySelector(`input[name="validade-${plu}"]`).value.trim());

    bolean = descricao == "" || isNaN(preco) || isNaN(vendaSelect) || isNaN(validade)
...
function novo() {
    ...
    let vendaSelect = parseInt(document.querySelector(`select[name="venda-new"]`).value.trim());
    let venda = vendaSelect
    let validade = parseInt(document.getElementById("validade-new").value)

    console.log(pluHtml.value)
    let pluInvalido = isNaN(pluHtml.value) || descricao == "" || isNaN(preco) || isNaN(venda) || isNaN(validade) 
